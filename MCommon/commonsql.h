...
public:
    CommonSQL();
    static QSqlQueryModel* GetAllFilesFromDatabase(bool isShowAll = false, bool notAW = false);
    static QSqlQueryModel* GetAllFilesFromDatabaseForBin(bool isShowAll = false);
    static QSqlQueryModel* GetAllInfoFromAccount(QList<QString> lstIdFile, bool isGetActive = true,bool foraw=false);
    ...
    static QSqlQueryModel* GetIdStatus();
    static QSqlQueryModel* GetAccFromFile(QList<QString>* lstIdFile = new QList<QString>(), QString info = "", bool isGetActive = true);
