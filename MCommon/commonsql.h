...
public:
    CommonSQL();
    static AutoTable* GetAllFilesFromDatabase(bool isShowAll = false, bool notAW = false);
    static AutoTable* GetAllFilesFromDatabaseForBin(bool isShowAll = false);
    static AutoTable* GetAllInfoFromAccount(QList<QString> lstIdFile, bool isGetActive = true,bool foraw=false);
    ...
    static AutoTable* GetIdStatus();
    static AutoTable* GetAccFromFile(QList<QString>* lstIdFile = new QList<QString>(), QString info = "", bool isGetActive = true);
